...
Elm.Http = Elm.Http || {};
Elm.Http.Listeners = Elm.Http.Listeners || {};
Elm.Http.Listeners.make = function (_elm) {
   "use strict";
   _elm.Http = _elm.Http || {};
   _elm.Http.Listeners = _elm.Http.Listeners || {};
   if (_elm.Http.Listeners.values)
   return _elm.Http.Listeners.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Http.Listeners",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _elm.Http.Listeners.values = {_op: _op
                                ,on: on};
   return _elm.Http.Listeners.values;
};
Elm.Http = Elm.Http || {};
Elm.Http.Request = Elm.Http.Request || {};
Elm.Http.Request.make = function (_elm) {
   "use strict";
   _elm.Http = _elm.Http || {};
   _elm.Http.Request = _elm.Http.Request || {};
   if (_elm.Http.Request.values)
   return _elm.Http.Request.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Basics = Elm.Basics.make(_elm),
   $Http$Listeners = Elm.Http.Listeners.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var onCloseReq = $Http$Listeners.on("close");
   ...
   var POST = {ctor: "POST"};
   var GET = {ctor: "GET"};
   _elm.Http.Request.values = {_op: _op
                              ,emptyReq: emptyReq
...
Elm.Http = Elm.Http || {};
Elm.Http.Response = Elm.Http.Response || {};
Elm.Http.Response.make = function (_elm) {
   "use strict";
   _elm.Http = _elm.Http || {};
   _elm.Http.Response = _elm.Http.Response || {};
   if (_elm.Http.Response.values)
   return _elm.Http.Response.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Http.Response",
   $Basics = Elm.Basics.make(_elm),
   $Http$Listeners = Elm.Http.Listeners.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var onFinishRes = $Http$Listeners.on("finish");
   var onCloseRes = $Http$Listeners.on("close");
   ...
   var Response = function (a) {
      return {_: {},statusCode: a};
   };
   _elm.Http.Response.values = {_op: _op
                               ,emptyRes: emptyRes
                               ,textHtml: textHtml
...
Elm.Http = Elm.Http || {};
Elm.Http.Response = Elm.Http.Response || {};
Elm.Http.Response.Write = Elm.Http.Response.Write || {};
Elm.Http.Response.Write.make = function (_elm) {
   "use strict";
   _elm.Http = _elm.Http || {};
   _elm.Http.Response = _elm.Http.Response || {};
   _elm.Http.Response.Write = _elm.Http.Response.Write || {};
   if (_elm.Http.Response.Write.values)
   return _elm.Http.Response.Write.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Http.Response.Write",
   $Basics = Elm.Basics.make(_elm),
   $Http$Response = Elm.Http.Response.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Http$Response$Write = Elm.Native.Http.Response.Write.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm),
   $VirtualDom = Elm.VirtualDom.make(_elm);
   var end = $Native$Http$Response$Write.end;
   var write = $Native$Http$Response$Write.write;
   var writeHead = $Native$Http$Response$Write.writeHead;
   ...
   var writeHtml = writeAs($Http$Response.textHtml);
   var writeJson = F2(function (val,
   res) {
      return A3(writeAs,
      $Http$Response.applicationJson,
      A2($Json$Encode.encode,0,val),
      res);
   });
   var writeFile = F2(function (file,
   res) {
      return A2($Task.andThen,
      A2($Task.andThen,
      A3(writeHead,
      200,
      $Http$Response.textHtml,
      res),
      $Native$Http$Response$Write.writeFile(file)),
      end);
   });
   var writeElm = F2(function (file,
   res) {
      return A2($Task.andThen,
      A2($Task.andThen,
      A3(writeHead,
      ...
      $Http$Response.textHtml,
      res),
      $Native$Http$Response$Write.writeElm(file)),
      end);
   });
   var writeNode = F2(function (node,
   res) {
      return A2($Task.andThen,
      A2($Task.andThen,
      A3(writeHead,
      ...
      $Http$Response.textHtml,
      res),
      $Native$Http$Response$Write.writeNode(node)),
      end);
   });
   _elm.Http.Response.Write.values = {_op: _op
                                     ,write: write
                                     ,writeHead: writeHead
                                     ,writeHtml: writeHtml
                                     ,writeJson: writeJson
...
Elm.Http.Server.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Http$Listeners = Elm.Http.Listeners.make(_elm),
   $Http$Request = Elm.Http.Request.make(_elm),
   $Http$Response = Elm.Http.Response.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Http = Elm.Native.Http.make(_elm),
   ...
   var onClose = $Http$Listeners.on("close");
   var onRequest = $Http$Listeners.on("request");
...
Elm.Main.make = function (_elm) {
   ...
   $Http$Request = Elm.Http.Request.make(_elm),
   $Http$Response = Elm.Http.Response.make(_elm),
   $Http$Response$Write = Elm.Http.Response.Write.make(_elm),
            ...
            return function () {
                 ...
                 {case "GET":
                    return function () {
                         ...
                         switch (_v5)
                         {case "/":
                            return A2($Http$Response$Write.writeFile,
                              "/index.html",
                              _v0._1);}
                         return A2($Http$Response$Write.writeFile,
                         _v5,
                    ...
                    case "POST":
                    return $Task.succeed({ctor: "_Tuple0"});}
                 return $Http$Response$Write.writeJson($Json$Encode.string("unknown method!"))(_v0._1);
              }();}
         _U.badCase($moduleName,
         "between lines 21 and 36");
      }();
   };
   var server = $Signal.mailbox({ctor: "_Tuple2"
                                ,_0: $Http$Request.emptyReq
                                ,_1: $Http$Response.emptyRes});
